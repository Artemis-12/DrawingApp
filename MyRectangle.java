...
public class MyRectangle implements MyShape{
    ...
    public MyRectangle(Point2D.Double first,Point2D.Double second,Paint c,boolean filled,Stroke stroke){
        this.first = first;
        this.second = second;
        color = c;
        this.filled = filled;
    ...
    public void draw(Graphics2D g2d){
        Rectangle2D.Double rect = new Rectangle2D.Double(first.getX(), first.getY(),
